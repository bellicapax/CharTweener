...
{
    public class CharTweenExampleFullUGUI : MonoBehaviour
    {
        public TextMeshProUGUI Target;
        private CharTweenerUGUI _tweener;
        ...
        public void Start()
        {
            _tweener = Target.GetCharTweenerUGUI();
        ...
        private void Tween2(int start, int end)
        {
            ...
            {
                var timeOffset = Mathf.Lerp(0, 1, (i - start) / (float)(end - start + 1));
                _tweener.DOShakePosition(i, 1, _strength, _vibrato, _randomness, false, false)
                    .SetLoops(-1, LoopType.Restart);
        ...
        private void Tween5(int start, int end)
        {
            ...
            {
                var timeOffset = Mathf.Lerp(0, 1, (i - start) / (float)(end - start + 1));
                var anchorposTween = _tweener.DOAnchorPosY(i, -50, 1f)
                    .From()
